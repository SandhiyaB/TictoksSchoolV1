                ...
                console.log("res",data);
                 if (data.homeRetrieveList.length != 0) {
                    ...
                    $.each(data.homeRetrieveList, function (i, item) {
                        tab += '<tr class="success" ><td>' + j + '</td><td>' + item.date + '</td><td>' + item.subjectName + '</td><td>' + item.type + '</td><td>' + item.description + '</td><td>' + item.additional + '</td><td>' + item.completionDate + '</td><td width="50%"> <select class="SelectOption"><option value="notCompleted">Not Completed</option> <option value="completed">Completed</option></select></td><td><button class="Submit" > Submit</button></td></tr>';
                   j++;
                    });
